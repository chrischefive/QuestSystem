...
namespace Sisus
{
	public sealed class EditorGUIDrawer : DrawGUI
	{
		...
		/// <summary>
		/// In certain scenarios foldouts inside custom property drawers will be drawn at incorrect positions unless
		/// EditorStyles.foldout.margin.left is set to the value -12. This property can be used to determine if the
		/// fix should be applied in the current project before drawing custom editors and property drawers.
		/// </summary>
