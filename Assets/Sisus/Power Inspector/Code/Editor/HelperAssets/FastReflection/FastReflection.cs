...
#if CSHARP_7_3_OR_NEWER //doesn't compile with Scripting Runtime Version: .NET 4.x Equivalent and Api Compatibility Level: .NET Standard 2.0 combination for some reason
using System;
using System.Linq;
